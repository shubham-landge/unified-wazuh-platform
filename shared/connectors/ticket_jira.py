...
class JiraConnector(TicketConnector):
    def __init__(self, url: str | None = None, email: str | None = None, api_token: str | None = None):
        ...
        self.api_token = api_token or settings.jira_api_token.get_secret_value() if settings.jira_api_token else ""
        ...
        payload = {
            "fields": {
                ...
                "description": {
                    ...
                    "version": 1,
                    "content": [
                        {"type": "paragraph", "content": [{"type": "text", "text": case_data.get("description", "")}]}
                    ],
                },
                "issuetype": {"name": "Task"},
